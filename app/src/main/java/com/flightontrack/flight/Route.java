...
public class Route {
    ...
    public FlightInstance activeFlight;
    //public RSTATUS _routeStatus = RSTATUS.PASSIVE;
...
//    public void setTrackingButtonState(BUTTONREQUEST request) {
...
//                MainActivity.trackingButton.setText("Flight " + (activeFlight.flightNumber) + ctxApp.getString(R.string.tracking_ready_to_takeoff));
...
//    }
    ...
    private void set_ActiveFlightID(FlightInstance f) {
